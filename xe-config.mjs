...
<template ${{
    ...
    rowTransform: {
        ...
        valueClasses: [{ name: "path", id: "path" }, {}, { readonly: "hasChildren", "data-value-type": "type" }],
        '^': [iff, { lhs: 'type', op: '===', rhsVal: 'boolean' }, [{ type: ['checkbox'], checked: 'value' }]],
        '^^': [iff, { lhs: 'type', op: '===', rhsVal: 'string' }, [{ value: "asString", type: ['text'] }]],
        '^3': [iff, { lhs: 'type', op: '===', rhsVal: 'number' }, [{ value: 'value', type: ['number'] }]],
        '^4': [iff, { lhs: 'type', op: '===', rhsVal: 'object' }, [{ type: ['text'], value: 'asString', class: 'object-adder' }]],
