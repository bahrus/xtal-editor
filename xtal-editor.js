...
<style be-loaded='{"fallback":"https://cdn.jsdelivr.net/npm/xtal-editor@0.0.150/theme.css","preloadRef":"xtal-editor/theme.css","removeStyle":true}'>
...
<header part=header>
    ...
    <div class=exp-coll>
        <button class="action expand-all" aria-label="expand all" title="expand all" be-noticed='{"click":{"toNearestUpMatch":"xtal-tree","prop":"expandAll","val":true}}'>&nbsp;</button>
        <button class="action collapse-all" aria-label="collapse all" title="collapse all" be-noticed='{"click":{"toNearestUpMatch":"xtal-tree","prop":"collapseAll","val":true}}'>&nbsp;</button>
        <button class="action copy" aria-label="copy" title="copy" name="" be-noticed='{"click":{"toNearestUpMatch":"xtal-tree","prop":"copyNodeToClipboard","vft":"."}}'>&nbsp;</button>
    </div>
</header>
<!-- Tree View -->
