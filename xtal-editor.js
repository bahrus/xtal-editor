...
<main part=main>
    ...
    <template be-switched='{"if":".treeView"}'>
        ...
        <xtal-vlist
            ...
            row-transform='{"divEs":[{},{},{"data-path":"path"}],"fieldCs":[{},{},{"style":"marginStyle"}],"keyCs":[{"textContent":"name"},{},{"data-type":"type","for":"path"}],"valueCs":[{"name":"path","id":"path"},{},{"data-value-type":"type"}],"^":[true,{"lhs":"type","op":"===","rhsVal":"boolean"},[{"readOnly":false,"type":["checkbox"],"checked":"value"}]],"^^":[true,{"lhs":"type","op":"===","rhsVal":"string"},[{"readOnly":false,"type":["text"],"value":"asString"}]],"^3":[true,{"lhs":"type","op":"===","rhsVal":"number"},[{"readOnly":false,"type":["number"],"value":"value"}]],"^4":[true,{"lhs":"type","op":"===","rhsVal":"object"},[{"readOnly":true,"type":["text"],"value":"asString","class":"object-adder"}]],"^5":[true,{"lhs":"type","op":"===","rhsVal":"array"},[{"readOnly":true,"type":["text"],"value":"asString","class":"object-adder"}]],".delete,.copy,.expand-all":[{"name":"path","id":"path"}],"expanderCs":[true,{"if":"open"},["-"],["+"]],"buttonEs":[{"name":"path"},{},{"data-children":"hasChildren"}],".adder-buttons,.exp-collapse-buttons":[{},{},{"data-children":"hasChildren","data-can-have-children":"canHaveChildren"}],".adder-template,.exp-coll-template":[{".beDecorated.lazy.host":"."}],"template[be-lazy],template[is-lazy]":[{".beDecorated.lazy.ctx":":"}]}'row-intersectional-settings='{"rootClosest":".scroller","options":{"rootMargin":"600px","threshold":0}}'
        >
